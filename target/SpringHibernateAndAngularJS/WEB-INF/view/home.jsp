  ...
  <body ng-app="myApp">
   <div ng-controller="PersonController as personCtrl">
	...
	<form name="personForm" method="POST">
		...
		<tr>
		      <td>Phone Number: </td> <td> <input type="text" name="phonenumber" ng-model="personCtrl.person.phonenumber" required/> 
	              <span ng-show="personForm.phonenumber.$error.required" class="msg-val">Phone number is required.</span> </td>
		</tr>
		<tr>
		      <td>Email: </td> <td> <input type="text" name="email" ng-model="personCtrl.person.email" required/> 
	              <span ng-show="personForm.email.$error.required" class="msg-val">Email is required.</span> </td>
		</tr>
		<tr>
        ...
        <table cellspacing="2" cellpadding="1" border="1px solid grey">
	      <tr><th>ID </th> <th>Name</th> <th>Location</th> <th>Phone Number</th> <th>E-mail</th></tr>
